...
function KonfiguratorPageInner() {
  ...
  // pobieramy ustawienia anty-spam z tabeli settings (jeśli istnieją)
  useEffect(() => {
  ...
  // pobieramy opcje konfiguratora (stal / RAL) z settings
  useEffect(() => {
          ...
          <div className="space-y-8 lg:col-span-2">
            ...
            {step === 3 && (
              <div className="animate-in fade-in duration-500">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {(steelTypes.length ? steelTypes : [{ label: "Stal (opcja)" }]).map(
                    (item) => (
                      <button
                        key={item.label}
                        type="button"
